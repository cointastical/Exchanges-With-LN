...
- [Bisq](https://Bisq.network/) (💵, [⚡](https://lightningnetworkstores.com/wallets)) [**NO KYC**] <-- [Lightning network is implemented simply as a payment method allowed for buying or selling bitcoin]
